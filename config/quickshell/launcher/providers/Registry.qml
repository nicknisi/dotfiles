...
Item {
  ...
  readonly property var bundled: [system, applications, converter, calculator, colors, emoji, clipboard, dictation, files, hotkeys, codex, aiWeb, extensions, settingsProvider, timerProvider]
