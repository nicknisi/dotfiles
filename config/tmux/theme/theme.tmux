...
thm_bg_dark1=$(get_tmux_option "@bg_dark1")
thm_bg_highlight=$(get_tmux_option "@bg_highlight")
thm_fg=$(get_tmux_option "@thm_fg")
thm_fg_dark=$(get_tmux_option "@fg_dark")
thm_fg_gutter=$(get_tmux_option "@fg_gutter")
...
thm_magenta2=$(get_tmux_option "@magenta2")
thm_pink=$(get_tmux_option "@thm_pink")
thm_red=$(get_tmux_option "@thm_red")
thm_red1=$(get_tmux_option "@red1")
thm_green=$(get_tmux_option "@thm_green")
thm_green1=$(get_tmux_option "@green1")
thm_green2=$(get_tmux_option "@green2")
thm_yellow=$(get_tmux_option "@thm_yellow")
thm_blue=$(get_tmux_option "@thm_blue")
thm_blue0=$(get_tmux_option "@blue0")
thm_blue1=$(get_tmux_option "@blue1")
thm_blue2=$(get_tmux_option "@blue2")
thm_blue5=$(get_tmux_option "@blue5")
thm_blue6=$(get_tmux_option "@blue6")
thm_blue7=$(get_tmux_option "@blue7")
thm_orange=$(get_tmux_option "@thm_orange")
thm_purple=$(get_tmux_option "@thm_purple")
thm_black4=$(get_tmux_option "@thm_black4")
thm_comment=$(get_tmux_option "@comment")
thm_dark3=$(get_tmux_option "@dark3")
thm_dark5=$(get_tmux_option "@dark5")
thm_teal=$(get_tmux_option "@teal")
thm_terminal_black=$(get_tmux_option "@terminal_black")
